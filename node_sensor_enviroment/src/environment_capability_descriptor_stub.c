 ...
 * advertised by the environment sensor node.
...
static const char ENVIRONMENT_DESCRIPTOR_JSON[] =
    "{"
    "\"schemaVersion\":1,"
    ...
    "\"metrics\":["
    "{\"key\":\"ambientTemperature\",\"unit\":\"degC\",\"source\":\"DHT22\",\"role\":\"primary\",\"type\":\"number\"},"
    "{\"key\":\"relativeHumidity\",\"unit\":\"percent_rh\",\"source\":\"DHT22\",\"role\":\"primary\",\"type\":\"number\"},"
    "{\"key\":\"co\",\"unit\":\"ppm\",\"source\":\"MQ7\",\"role\":\"sampled_after_heater_cycle\",\"type\":\"number\"},"
    "{\"key\":\"pm25\",\"unit\":\"ug_m3\",\"source\":\"GP2Y1014\",\"role\":\"sampled\",\"type\":\"number\"},"
    "{\"key\":\"pressure\",\"unit\":\"hPa\",\"source\":\"CJMCU680\",\"role\":\"sampled\",\"type\":\"number\"},"
    "{\"key\":\"eco2\",\"unit\":\"ppm\",\"source\":\"CJMCU680\",\"role\":\"algorithm_estimate\",\"type\":\"number\"},"
    "{\"key\":\"tvoc\",\"unit\":\"ppb\",\"source\":\"CJMCU680\",\"role\":\"algorithm_estimate\",\"type\":\"number\"}"
    "],"
    "\"events\":[{\"key\":\"sensor.fault\",\"severity\":\"warning\",\"payloadSchema\":\"generic-key-value\"}],"
    "\"actions\":[],"
...
{
    return environment_capability_descriptor_json();
}

const char *environment_capability_descriptor_json(void)
{
    return ENVIRONMENT_DESCRIPTOR_JSON;
}
...
{
    environment_capability_descriptor_t decoded;

    if (!environment_capability_descriptor_decode(environment_capability_descriptor_json(), &decoded)) {
        return 0;
    }

    return strcmp(decoded.node_type, "environment.sensor") == 0 &&
           decoded.schema_version == 1 &&
           strcmp(decoded.display_name, "Environment Sensor Node") == 0 &&
